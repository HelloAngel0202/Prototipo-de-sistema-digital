...
router.post("/register-payment", Lender.registerPayment);
router.get("/payments-by-condition", Lender.getPaymentsByCondition);
router.get("/payments-by-client", Lender.getPaymentsByClient);
